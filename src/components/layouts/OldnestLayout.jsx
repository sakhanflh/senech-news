...
export function OldnestLayout({ apiUrl, sliceInner, sliceCol, sliceCol2, info, heading }) {
    ...
    const dataCol2 = data?.data?.posts?.slice(sliceCol2.start, sliceCol2.end) || [];
            ...
            <section className="flex w-full flex-col xl:flex-row xl:justify-between gap-10">
                <div className="xl:w-[60%] w-full flex flex-col">
                    <div className="border-b border-black border-opacity-25">
                        <p className="border-b-2 border-primary max-w-24 text-2xl font-medium text-primary">{heading}</p>
                    </div>
                ...
                <div className="xl:w-[35%] flex flex-col gap-5 ">
                    <div className="border-b border-black border-opacity-25">
                        <p className="border-b-2 border-primary max-w-28 text-2xl font-medium text-primary">Terfavorit</p>
                    </div>
                    {isLoading ?
                        arrLength2.map((_, i) => (
                            <article key={i} className="flex w-full gap-1">
